...
int	    execute(t_stock **g_cmd, char *envp[]);
...
int		parse_token(char *token, char **new_token, t_stock **g_cmd, char **envp);
...
int		ft_launch_process(t_stock **g_cmd, char **args, char *envp[]);
