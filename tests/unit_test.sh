...
'echo $var bonjour ; echo "" bonjour ; echo "12\"" ; echo bonjour \; ls'
'echo one; echo two; echo three;'		
'echo erreur ;; echo nul'				
'echo -nnnn -n Test option n ; echo $'
'echo 123$USER----$ ; echo "hallo$"'	
'echo abc$USERdef ; echo "hoi$USERmaran" ; echo $var test'	
'echo $_1234 ; echo $lol.ok ; echo $/.ok'	
'echo $? ; export valid_var=ok ; export unvalid-var=ko ; unset valid_var ; unset unvalid=ko'
'echo $? ; export ok$HOME'																
'echo $? ; unset po1 1op 2 po2; echo $? $po1 $po2'										
'echo $? ; exit 0 1 ;;'																	
'echo $? ; export valid unvalid. unvalid2$ ; unset valid unvalid. unvalid2$'				
'echo $? ; echo error > ; echo KO'														
'echo $? ; echo error >; echo KO'															
'echo $? ; echo ko > is_$HOME'			
'echo $? ; echo ko > $VAR_NOT_FOUND'														
'echo $? ; echo ko > \$VAR_NOT_FOUND;echo ko > '$VAR_NOT_FOUND';echo ko >'
'echo $? ; ./echo ko; echo $?'															
#### ENV ####
#'env'
#### EXPORT ####
'export ok;  echo $ok.ko'
'export Z=z ; echo $Z'
